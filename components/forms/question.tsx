...
import { QuestionsSchema } from "@/validation/validation";
import { Badge } from "../ui/badge";
import Image from "next/image";
import { createQuestion, editQuestion } from "@/actions/questions";
import { useRouter, usePathname } from "next/navigation"; // Client-side hooks
...
const Question = ({ type, mongoUserId, questionDetails }: Props) => {
  ...
  const form = useForm<z.infer<typeof QuestionsSchema>>({
    ...
    defaultValues: {
      ...
      tags: groupedTags || [], // Ensure tags are included in default values
    },
  });
